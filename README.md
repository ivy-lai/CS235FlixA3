...
Testing requires that file *COMPSCI235FlixSkeleton/tests/conftest.py* be edited to set the value of `TEST_DATA_PATH`. 
You should set this to the absolute path of the *COMPSCI235FlixSkeleton/tests/data* directory. 
